  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <Link to="/admin/players" className="glass i-lift rounded-2xl p-6 hover:-translate-y-0.5 transition-transform">
        ...
        <Link to="/admin/tournaments" className="glass i-lift rounded-2xl p-6 hover:-translate-y-0.5 transition-transform">
