  ...
  return (
    <Layout>
      ...
      <section key={`h-${period}`} className="mt-6 grid gap-3 md:grid-cols-3 stagger">
        {rows[0] && (
          <div className="glass a-up i-glow-edge rounded-2xl p-4 flex items-center gap-3 neon-border">
        ...
        {rows.length > 0 && (() => {
          ...
          return (
            <div className="glass a-up i-glow-edge rounded-2xl p-4 flex items-center gap-3">
